...
## Sprint 7 — Топбар, навигация и визуальная консистентность (2026-02-22)

### Описание
Спринт направлен на унификацию верхней панели Novikov: выравнивание топбара по ширине с карточками, перенос меню в правую группу, согласование размеров/типографики контролов и сохранение полной работоспособности поиска/настроек.

### Цель
Сделать топбар визуально цельным и консистентным с карточками, сохранив текущую архитектуру и конфиг-управляемое меню.

---

## Задача 7.1 — Геометрия и выравнивание топбара

### Описание / DoD
- Топбар визуально совпадает по левому/правому краям с сеткой карточек.
- Топбар имеет форму карточки (граница + скругление), без лишней тени.
- Прозрачность топбара корректна для светлой и темной тем.
**Статус:** ✅ Done

- топбар: `border: 1px solid var(--stroke)` + `border-radius: var(--radius)`
- светлый фон: `rgba(255,255,255,0.85)`
- темный фон: `rgba(30,30,30,0.85)`
- выравнивание выполнено через согласованные внутренние отступы контейнеров

---

## Задача 7.2 — Конфиг-управляемое меню и компоновка справа

### Описание / DoD
- Верхнее меню рендерится из `config.menus`.
- Для Novikov доступны пункты Bar/Coffee/Pastry/Wine.
- Меню располагается в правой зоне рядом с поиском и настройками.
**Статус:** ✅ Done

---

## Задача 7.3 — Унификация контролов поиска и настроек

### Описание / DoD
- Поиск и настройки объединены в единую визуальную группу.
- Контролы имеют одинаковую высоту и единый стиль оболочки.
- Кнопка настроек использует лаконичный символ без emoji-стиля.
**Статус:** ✅ Done

- высота меню/поиска/настроек: `36px`
- ширина поиска: `96px`
- символ настроек: `⋮`

---

## Задача 7.4 — Типографика и финальные параметры UI

### Описание / DoD
- Размер шрифта меню/поиска/настроек унифицирован.
- Вес шрифта приведен к согласованному виду с выделением активного меню.
- Логотип топбара увеличен без изменения остальной структуры.
**Статус:** ✅ Done

- размер меню/поиска/настроек: `16px`
- вес меню/поиска/настроек: `450`
- вес активного меню: `500`
- размер лого: `60×60`
